import { goog } from './pluralrules.js';
...
goog.soy.data.SanitizedContentKind = {
  ...
  // GENERATOR TODO: Consider separating rules, declarations, and values into
...
// GENERATOR TODO: This function is probably necessary, either externally or internally
...
/**
 * Used for {plural} tags in translations to select the right plural form
 * Returns an index based on the numeric value referenced by the text
 * The index is for the translation to use from the .po file from Smartling
 * See https://help.smartling.com/hc/en-us/articles/360008144493-Plurals
 * Indices and rules are a Unicode standard
 * http://www.unicode.org/cldr/charts/27/supplemental/language_plural_rules.html
 *
 * @param {number} value The numeric value referenced by the text
 * @param {string} locale The locale to be translated to
 * @return {number} The index of the translation to use
 */
soy.$$pluralIndex = function(value, locale = (window && window.Yext && window.Yext.locale) || 'en') {
  return goog.i18n.pluralRules.select(locale, value).index;
};
...
soy.$$escapeHtml = function(value) {
  // GENERATOR TODO: Perhaps we should just ignore the contentKind property and instead
...
soy.$$filterHtmlAttributes = function(value) {
  ...
  // GENERATOR TODO: Dynamically inserting attributes that aren't marked as trusted is
...
soy.$$escapeJsString = function(value) {
  if (value &&
    ...
    // GENERATOR TODO: It might still be worthwhile to normalize it to remove
...
root.soy = soy;
root.goog = goog;
})((typeof global !== 'undefined' && global !== null) ? global : this, goog)
